...
export default function DatabaseSetup({ userId = 'demo-user' }: DatabaseSetupProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
          ...
          {supabaseConfigured && (
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-medium transition-colors hover:bg-gray-100:bg-gray-700"
              >
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Clear Local Data</h2>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-gray-900">Supabase Setup</h2>
          <button
        ...
        {!supabaseConfigured && (
          <div className="bg-blue-50/20 border border-blue-200 rounded-lg p-4 mb-4">
            <div className="flex items-start gap-3">
              <AlertCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-medium text-blue-900">Supabase Not Configured</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-medium text-gray-900">Database Schema (SQL)</h4>
                <button
                  onClick={copySchemaToClipboard}
                  className="flex items-center gap-2 px-3 py-1 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300:bg-gray-600 transition-colors text-sm"
                >
                  {copiedSchema ? (
                    <>
            ...
            <div className="bg-yellow-50/20 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
      ...
      {/* How It Works */}
      <div className="bg-white rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">How the Hybrid System Works</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900">Cache-First Access</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-gray-900">Offline Support</h3>
                <p className="text-sm text-gray-600">
        ...
        <div className="mt-6 bg-blue-50/20 border border-blue-200 rounded-lg p-4">
          <h4 className="font-medium text-blue-900 mb-2">Benefits of Hybrid Approach</h4>
