...
export default function MobileNav() {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 transition-transform duration-300 ${
            ...
            <Link
              ...
              className={`flex flex-col items-center justify-center p-2 rounded-lg transition-colors min-w-0 ${
                isActive
                  ...
                  : 'text-gray-600 hover:text-blue-600:text-blue-400'
              }`}
              title={item.label}
            >
